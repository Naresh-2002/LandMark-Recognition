...
def run():
    ...
    if img_file is not None:
        save_image_path.extractall('https://github.com/Naresh-2002/LandMark-Recognition/blob/2ee380b1114b5d8e8c782ea549f0ddfbde26218d/Uploaded_Images.rar') + img_file.name
